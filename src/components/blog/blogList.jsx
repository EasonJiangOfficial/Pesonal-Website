  ...
  return (
    <div className="mt-28 gap-12 place-items-center grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
      {blogPosts.map((blogPost, index) => (
        ...
        <div
          key={index}
          className="hover:from-gradient-end-red hover:to-red-800 hover:-translate-y-4 hover:shadow-2xl hover:ease-in duration-200 rounded-[30px] bg-gradient-to-b from-gradient-start-red to-gradient-end-red p-4 w-full h-[30em] sm:h-[30rem] md:h-[32rem] lg:h-[34rem] flex flex-col justify-center items-center text-white"
          data-aos="fade-right"
